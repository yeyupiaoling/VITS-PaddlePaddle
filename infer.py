...
from ppvits.predict import PPVITSPredictor
from ppvits.utils.utils import print_arguments

parser = argparse.ArgumentParser(description='vits inference')
# 必须参数
parser.add_argument('-c', '--config_path', type=str, default="models/config.yml", help='配置文件路径')
...
predictor = PPVITSPredictor(configs=args.config_path, model_path=args.model_path)
